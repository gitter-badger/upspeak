...
-- Btree index of team IDs in namespaces to quickly lookup the team for a specific slug
create index namespace_team_id_idx on public.namespaces using btree (team_id);

-- Btree index of team IDs in namespaces to quickly lookup the user for a specific slug
